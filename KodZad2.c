...
unsigned int setdelay(unsigned int zkanalu)
{
    //na podstawie przeslanego odczytu z Potencjometru P2 dopasowuje
    //liczbe miliskeund do przerwy
    if(zkanalu>80)
    {
        return 500;
    }
...
void main(void) {
 ...
 ////////////////////////////////////////////////////////////////////////       
        ...
        /*najpierw wykonuje funkcje adc, aby odczytac wartosc z potencjometru P2
         * nastepnie przeslana wartosc przekazuje funkcji set delay, ktora na
         * jej podstawie dopasuje czas przerwy
         */
        delay(setdelay((unsigned int)adc(1) / 10));
        if(PORTBbits.RB4 == 0)
        {
            //przejscie do poprzedniego programu
            delay(1000);
            goto grayUP;
        }
        else
        {  
            //sprawdzenie wartosci na bitach 0,1,3,4
            ...
            //jezeli xoro =1 to przekreca ostatni bit
            if(xoro==1)
            {
                display ^= 1UL << 5;
            }
